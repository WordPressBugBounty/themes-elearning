/**
 * eLearning frontend JS file.
 */

var elearningFrontend = {
...
window.elearningFrontend = elearningFrontend;
	...
	function() {
		function mobileNavigation() {
			...
			if ( toggleButton && menu ) {
				...
				elearningFrontend.toggleMenu( toggleButton, menu, overlayWrapper, closeButton, toggleButton );
