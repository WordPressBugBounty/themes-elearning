				...
				<div class="metabox-holder">
					<div class="elearning-header" >
						<div class="elearning-container">
							<a class="elearning-title" href="<?php echo esc_url( 'https://masteriyo.com/elearning-lms-theme/' ); ?>" target="_blank">
							...
							<div>
								<a href="<?php echo esc_url( 'https://masteriyo.com/elearning-lms-theme/' ); ?>" target="_blank"><?php esc_html_e( 'Theme Info', 'elearning' ); ?></a>
