	...
	'elearning_footer_builder_widget_2_heading' => array(
		...
		'sub_controls' => apply_filters(
			...
			array(
				...
				'elearning_footer_widget_2_heading_border_divider' => array(
					'type'    => 'customind-divider',
					'variant' => 'dashed',
					'section' => 'elearning_footer_builder_widget_1',
				),
				'elearning_footer_widget_2_heading_border' => array(
					'default'     => array(
						'size'  => '',
						'units' => 'px',
					),
				...
				'elearning_footer_widget_2_heading_border_group' => array(
					...
					'sub_controls' => apply_filters(
						...
						array(
							'elearning_footer_widget_2_heading_border_color'       => array(
								'default' => '',
								'type'    => 'customind-color',
								'title'   => esc_html__( 'Normal', 'elearning' ),
								'section' => 'elearning_colors',
							),
							'elearning_footer_widget_2_heading_border_accent_color' => array(
								'default' => '',
								'type'    => 'customind-color',
