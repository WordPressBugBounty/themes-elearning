		...
		wp.customize.bind(
			...
			function () {
				...
				wp.customize.section.each(
					function ( section ) {
						if (
							'elearning_section' !== section.params.type ||
				...
				wp.customize.panel.each(
					function ( panel ) {
						if (
							'elearning_panel' !== panel.params.type ||
		...
		wp.customize.Panel = wp.customize.Panel.extend(
			{
				attachEvents         : function () {
					...
					if (
						'elearning_panel' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'elearning_panel' !== this.params.type ) {
		...
		wp.customize.Section = wp.customize.Section.extend(
			{
				attachEvents         : function () {
					...
					if (
						'elearning_section' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'elearning_section' !== this.params.type ) {
				...
				wp.customize.control.each(
					function ( ctrl, i ) {
						...
						if ( description.length ) {
							...
							li_wrapper.append( '<i class="elearning-control-tooltip dashicons dashicons-editor-help" title="' + tooltip + '"></i>' );
						}
					}
				);
			}
 ...
 *
 * Currently used for the eLearning Upseel section only.
 */
(
	function ( $, api ) {
		api.sectionConstructor[ 'elearning-upsell-section' ] = api.Section.extend(
			{
