 ...
 * Class eLearning_Title_Control
 */
class eLearning_Title_Control extends eLearning_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		...
		<div class="elearning-title-wrapper">
