		...
		public function elearning_container_migration() {
			...
			if ( ! empty( $color_palette ) && is_array( $color_palette ) && isset( $color_palette['colors'] ) && is_array( $color_palette['colors'] ) && ! empty( $color_palette['colors'] ) ) {
				...
				$color_id = array(
					...
					array( 'elearning_primary_menu_text_color', '' ),
					array( 'elearning_primary_menu_text_hover_color', '' ),
					array( 'elearning_primary_menu_text_active_color', '' ),
					...
					array( 'elearning_header_main_menu_color', '' ),
					array( 'elearning_header_main_menu_hover_color', '' ),
					array( 'elearning_header_main_menu_active_color', '' ),
